...
#define KDOC_VIDEO_PATH [NSString stringWithFormat:@"%@/Video", [ZSFileManager documentsDir]]
#define KTMP_VIDEO_PATH [NSString stringWithFormat:@"%@/Video", [ZSFileManager tmpDir]]
#define KDOC_UPLOAD_PATH [NSString stringWithFormat:@"%@/Upload", [ZSFileManager documentsDir]]
#define KTMP_COVER_PATH [NSString stringWithFormat:@"%@/Cover", [ZSFileManager tmpDir]]
...
/**
 ...
 @param path 目录的绝对路径
 @param extensions 需要遍历的文件扩展；
 @return 遍历结果数组
 */
+ (NSArray *)listFilesInDirectoryAtPath:(NSString *)path pathsMatchingExtensions:(NSArray *)extensions;
/**
 文件遍历
